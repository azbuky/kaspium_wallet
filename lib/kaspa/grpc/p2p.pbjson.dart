...
const RequestAddressesMessage$json = const {
  ...
  '2': const [
    const {
      '1': 'includeAllSubnetworks',
      '3': 1,
      '4': 1,
      '5': 8,
      '10': 'includeAllSubnetworks'
    },
    const {
      '1': 'subnetworkId',
      '3': 2,
...
final $typed_data.Uint8List requestAddressesMessageDescriptor =
    $convert.base64Decode(
        'ChdSZXF1ZXN0QWRkcmVzc2VzTWVzc2FnZRI0ChVpbmNsdWRlQWxsU3VibmV0d29ya3MYASABKAhSFWluY2x1ZGVBbGxTdWJuZXR3b3JrcxI7CgxzdWJuZXR3b3JrSWQYAiABKAsyFy5wcm90b3dpcmUuU3VibmV0d29ya0lkUgxzdWJuZXR3b3JrSWQ=');
...
final $typed_data.Uint8List addressesMessageDescriptor = $convert.base64Decode(
    'ChBBZGRyZXNzZXNNZXNzYWdlEjcKC2FkZHJlc3NMaXN0GAEgAygLMhUucHJvdG93aXJlLk5ldEFkZHJlc3NSC2FkZHJlc3NMaXN0');
...
final $typed_data.Uint8List netAddressDescriptor = $convert.base64Decode(
    'CgpOZXRBZGRyZXNzEhwKCXRpbWVzdGFtcBgBIAEoA1IJdGltZXN0YW1wEg4KAmlwGAMgASgMUgJpcBISCgRwb3J0GAQgASgNUgRwb3J0');
...
final $typed_data.Uint8List subnetworkIdDescriptor =
    $convert.base64Decode('CgxTdWJuZXR3b3JrSWQSFAoFYnl0ZXMYASABKAxSBWJ5dGVz');
...
final $typed_data.Uint8List transactionMessageDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List transactionInputDescriptor = $convert.base64Decode(
    'ChBUcmFuc2FjdGlvbklucHV0Ej8KEHByZXZpb3VzT3V0cG9pbnQYASABKAsyEy5wcm90b3dpcmUuT3V0cG9pbnRSEHByZXZpb3VzT3V0cG9pbnQSKAoPc2lnbmF0dXJlU2NyaXB0GAIgASgMUg9zaWduYXR1cmVTY3JpcHQSGgoIc2VxdWVuY2UYAyABKARSCHNlcXVlbmNlEh4KCnNpZ09wQ291bnQYBCABKA1SCnNpZ09wQ291bnQ=');
...
final $typed_data.Uint8List outpointDescriptor = $convert.base64Decode(
    'CghPdXRwb2ludBI+Cg10cmFuc2FjdGlvbklkGAEgASgLMhgucHJvdG93aXJlLlRyYW5zYWN0aW9uSWRSDXRyYW5zYWN0aW9uSWQSFAoFaW5kZXgYAiABKA1SBWluZGV4');
...
final $typed_data.Uint8List transactionIdDescriptor = $convert
    .base64Decode('Cg1UcmFuc2FjdGlvbklkEhQKBWJ5dGVzGAEgASgMUgVieXRlcw==');
...
final $typed_data.Uint8List scriptPublicKeyDescriptor = $convert.base64Decode(
    'Cg9TY3JpcHRQdWJsaWNLZXkSFgoGc2NyaXB0GAEgASgMUgZzY3JpcHQSGAoHdmVyc2lvbhgCIAEoDVIHdmVyc2lvbg==');
...
final $typed_data.Uint8List transactionOutputDescriptor = $convert.base64Decode(
    'ChFUcmFuc2FjdGlvbk91dHB1dBIUCgV2YWx1ZRgBIAEoBFIFdmFsdWUSRAoPc2NyaXB0UHVibGljS2V5GAIgASgLMhoucHJvdG93aXJlLlNjcmlwdFB1YmxpY0tleVIPc2NyaXB0UHVibGljS2V5');
...
final $typed_data.Uint8List blockMessageDescriptor = $convert.base64Decode(
    'CgxCbG9ja01lc3NhZ2USLgoGaGVhZGVyGAEgASgLMhYucHJvdG93aXJlLkJsb2NrSGVhZGVyUgZoZWFkZXISQQoMdHJhbnNhY3Rpb25zGAIgAygLMh0ucHJvdG93aXJlLlRyYW5zYWN0aW9uTWVzc2FnZVIMdHJhbnNhY3Rpb25z');
...
final $typed_data.Uint8List blockHeaderDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List blockLevelParentsDescriptor = $convert.base64Decode(
    'ChFCbG9ja0xldmVsUGFyZW50cxIzCgxwYXJlbnRIYXNoZXMYASADKAsyDy5wcm90b3dpcmUuSGFzaFIMcGFyZW50SGFzaGVz');
...
final $typed_data.Uint8List hashDescriptor =
    $convert.base64Decode('CgRIYXNoEhQKBWJ5dGVzGAEgASgMUgVieXRlcw==');
...
final $typed_data.Uint8List requestBlockLocatorMessageDescriptor =
    $convert.base64Decode(
        'ChpSZXF1ZXN0QmxvY2tMb2NhdG9yTWVzc2FnZRIrCghoaWdoSGFzaBgBIAEoCzIPLnByb3Rvd2lyZS5IYXNoUghoaWdoSGFzaBIUCgVsaW1pdBgCIAEoDVIFbGltaXQ=');
...
final $typed_data.Uint8List blockLocatorMessageDescriptor = $convert.base64Decode(
    'ChNCbG9ja0xvY2F0b3JNZXNzYWdlEicKBmhhc2hlcxgBIAMoCzIPLnByb3Rvd2lyZS5IYXNoUgZoYXNoZXM=');
...
final $typed_data.Uint8List requestHeadersMessageDescriptor = $convert.base64Decode(
    'ChVSZXF1ZXN0SGVhZGVyc01lc3NhZ2USKQoHbG93SGFzaBgBIAEoCzIPLnByb3Rvd2lyZS5IYXNoUgdsb3dIYXNoEisKCGhpZ2hIYXNoGAIgASgLMg8ucHJvdG93aXJlLkhhc2hSCGhpZ2hIYXNo');
...
final $typed_data.Uint8List requestNextHeadersMessageDescriptor =
    $convert.base64Decode('ChlSZXF1ZXN0TmV4dEhlYWRlcnNNZXNzYWdl');
...
final $typed_data.Uint8List doneHeadersMessageDescriptor =
    $convert.base64Decode('ChJEb25lSGVhZGVyc01lc3NhZ2U=');
...
final $typed_data.Uint8List requestRelayBlocksMessageDescriptor =
    $convert.base64Decode(
        'ChlSZXF1ZXN0UmVsYXlCbG9ja3NNZXNzYWdlEicKBmhhc2hlcxgBIAMoCzIPLnByb3Rvd2lyZS5IYXNoUgZoYXNoZXM=');
...
final $typed_data.Uint8List requestTransactionsMessageDescriptor =
    $convert.base64Decode(
        'ChpSZXF1ZXN0VHJhbnNhY3Rpb25zTWVzc2FnZRIqCgNpZHMYASADKAsyGC5wcm90b3dpcmUuVHJhbnNhY3Rpb25JZFIDaWRz');
...
final $typed_data.Uint8List transactionNotFoundMessageDescriptor =
    $convert.base64Decode(
        'ChpUcmFuc2FjdGlvbk5vdEZvdW5kTWVzc2FnZRIoCgJpZBgBIAEoCzIYLnByb3Rvd2lyZS5UcmFuc2FjdGlvbklkUgJpZA==');
...
final $typed_data.Uint8List invRelayBlockMessageDescriptor = $convert.base64Decode(
    'ChRJbnZSZWxheUJsb2NrTWVzc2FnZRIjCgRoYXNoGAEgASgLMg8ucHJvdG93aXJlLkhhc2hSBGhhc2g=');
...
final $typed_data.Uint8List invTransactionsMessageDescriptor =
    $convert.base64Decode(
        'ChZJbnZUcmFuc2FjdGlvbnNNZXNzYWdlEioKA2lkcxgBIAMoCzIYLnByb3Rvd2lyZS5UcmFuc2FjdGlvbklkUgNpZHM=');
...
final $typed_data.Uint8List pingMessageDescriptor =
    $convert.base64Decode('CgtQaW5nTWVzc2FnZRIUCgVub25jZRgBIAEoBFIFbm9uY2U=');
...
final $typed_data.Uint8List pongMessageDescriptor =
    $convert.base64Decode('CgtQb25nTWVzc2FnZRIUCgVub25jZRgBIAEoBFIFbm9uY2U=');
...
final $typed_data.Uint8List verackMessageDescriptor =
    $convert.base64Decode('Cg1WZXJhY2tNZXNzYWdl');
...
final $typed_data.Uint8List versionMessageDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List rejectMessageDescriptor = $convert
    .base64Decode('Cg1SZWplY3RNZXNzYWdlEhYKBnJlYXNvbhgBIAEoCVIGcmVhc29u');
...
final $typed_data.Uint8List requestPruningPointUTXOSetMessageDescriptor =
    $convert.base64Decode(
        'CiFSZXF1ZXN0UHJ1bmluZ1BvaW50VVRYT1NldE1lc3NhZ2USOwoQcHJ1bmluZ1BvaW50SGFzaBgBIAEoCzIPLnByb3Rvd2lyZS5IYXNoUhBwcnVuaW5nUG9pbnRIYXNo');
...
const PruningPointUtxoSetChunkMessage$json = const {
  ...
  '2': const [
    const {
      '1': 'outpointAndUtxoEntryPairs',
      '3': 1,
      '4': 3,
      '5': 11,
      '6': '.protowire.OutpointAndUtxoEntryPair',
      '10': 'outpointAndUtxoEntryPairs'
    },
  ],
};

/// Descriptor for `PruningPointUtxoSetChunkMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List pruningPointUtxoSetChunkMessageDescriptor =
    $convert.base64Decode(
        'Ch9QcnVuaW5nUG9pbnRVdHhvU2V0Q2h1bmtNZXNzYWdlEmEKGW91dHBvaW50QW5kVXR4b0VudHJ5UGFpcnMYASADKAsyIy5wcm90b3dpcmUuT3V0cG9pbnRBbmRVdHhvRW50cnlQYWlyUhlvdXRwb2ludEFuZFV0eG9FbnRyeVBhaXJz');
...
final $typed_data.Uint8List outpointAndUtxoEntryPairDescriptor =
    $convert.base64Decode(
        'ChhPdXRwb2ludEFuZFV0eG9FbnRyeVBhaXISLwoIb3V0cG9pbnQYASABKAsyEy5wcm90b3dpcmUuT3V0cG9pbnRSCG91dHBvaW50EjIKCXV0eG9FbnRyeRgCIAEoCzIULnByb3Rvd2lyZS5VdHhvRW50cnlSCXV0eG9FbnRyeQ==');
...
final $typed_data.Uint8List utxoEntryDescriptor = $convert.base64Decode(
    'CglVdHhvRW50cnkSFgoGYW1vdW50GAEgASgEUgZhbW91bnQSRAoPc2NyaXB0UHVibGljS2V5GAIgASgLMhoucHJvdG93aXJlLlNjcmlwdFB1YmxpY0tleVIPc2NyaXB0UHVibGljS2V5EiQKDWJsb2NrRGFhU2NvcmUYAyABKARSDWJsb2NrRGFhU2NvcmUSHgoKaXNDb2luYmFzZRgEIAEoCFIKaXNDb2luYmFzZQ==');
@$core.Deprecated(
    'Use requestNextPruningPointUtxoSetChunkMessageDescriptor instead')
...
final $typed_data.Uint8List
    requestNextPruningPointUtxoSetChunkMessageDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List donePruningPointUtxoSetChunksMessageDescriptor =
    $convert
        .base64Decode('CiREb25lUHJ1bmluZ1BvaW50VXR4b1NldENodW5rc01lc3NhZ2U=');
...
final $typed_data.Uint8List requestIBDBlocksMessageDescriptor =
    $convert.base64Decode(
        'ChdSZXF1ZXN0SUJEQmxvY2tzTWVzc2FnZRInCgZoYXNoZXMYASADKAsyDy5wcm90b3dpcmUuSGFzaFIGaGFzaGVz');
...
final $typed_data.Uint8List unexpectedPruningPointMessageDescriptor =
    $convert.base64Decode('Ch1VbmV4cGVjdGVkUHJ1bmluZ1BvaW50TWVzc2FnZQ==');
...
const IbdBlockLocatorMessage$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 11,
      '6': '.protowire.Hash',
      '10': 'blockLocatorHashes'
    },
  ],
};

/// Descriptor for `IbdBlockLocatorMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List ibdBlockLocatorMessageDescriptor =
    $convert.base64Decode(
        'ChZJYmRCbG9ja0xvY2F0b3JNZXNzYWdlEi8KCnRhcmdldEhhc2gYASABKAsyDy5wcm90b3dpcmUuSGFzaFIKdGFyZ2V0SGFzaBI/ChJibG9ja0xvY2F0b3JIYXNoZXMYAiADKAsyDy5wcm90b3dpcmUuSGFzaFISYmxvY2tMb2NhdG9ySGFzaGVz');
...
final $typed_data.Uint8List requestIBDChainBlockLocatorMessageDescriptor =
    $convert.base64Decode(
        'CiJSZXF1ZXN0SUJEQ2hhaW5CbG9ja0xvY2F0b3JNZXNzYWdlEikKB2xvd0hhc2gYASABKAsyDy5wcm90b3dpcmUuSGFzaFIHbG93SGFzaBIrCghoaWdoSGFzaBgCIAEoCzIPLnByb3Rvd2lyZS5IYXNoUghoaWdoSGFzaA==');
...
final $typed_data.Uint8List ibdChainBlockLocatorMessageDescriptor =
    $convert.base64Decode(
        'ChtJYmRDaGFpbkJsb2NrTG9jYXRvck1lc3NhZ2USPwoSYmxvY2tMb2NhdG9ySGFzaGVzGAEgAygLMg8ucHJvdG93aXJlLkhhc2hSEmJsb2NrTG9jYXRvckhhc2hlcw==');
...
final $typed_data.Uint8List requestAnticoneMessageDescriptor =
    $convert.base64Decode(
        'ChZSZXF1ZXN0QW50aWNvbmVNZXNzYWdlEi0KCWJsb2NrSGFzaBgBIAEoCzIPLnByb3Rvd2lyZS5IYXNoUglibG9ja0hhc2gSMQoLY29udGV4dEhhc2gYAiABKAsyDy5wcm90b3dpcmUuSGFzaFILY29udGV4dEhhc2g=');
...
final $typed_data.Uint8List ibdBlockLocatorHighestHashMessageDescriptor =
    $convert.base64Decode(
        'CiFJYmRCbG9ja0xvY2F0b3JIaWdoZXN0SGFzaE1lc3NhZ2USMQoLaGlnaGVzdEhhc2gYASABKAsyDy5wcm90b3dpcmUuSGFzaFILaGlnaGVzdEhhc2g=');
@$core.Deprecated(
    'Use ibdBlockLocatorHighestHashNotFoundMessageDescriptor instead')
...
final $typed_data.Uint8List
    ibdBlockLocatorHighestHashNotFoundMessageDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List blockHeadersMessageDescriptor = $convert.base64Decode(
    'ChNCbG9ja0hlYWRlcnNNZXNzYWdlEjoKDGJsb2NrSGVhZGVycxgBIAMoCzIWLnByb3Rvd2lyZS5CbG9ja0hlYWRlclIMYmxvY2tIZWFkZXJz');
@$core.Deprecated(
    'Use requestPruningPointAndItsAnticoneMessageDescriptor instead')
...
final $typed_data.Uint8List requestPruningPointAndItsAnticoneMessageDescriptor =
    $convert.base64Decode(
        'CihSZXF1ZXN0UHJ1bmluZ1BvaW50QW5kSXRzQW50aWNvbmVNZXNzYWdl');
@$core.Deprecated(
    'Use requestNextPruningPointAndItsAnticoneBlocksMessageDescriptor instead')
...
final $typed_data.Uint8List
    requestNextPruningPointAndItsAnticoneBlocksMessageDescriptor =
    $convert.base64Decode(
...
const BlockWithTrustedDataMessage$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.protowire.BlockGhostdagDataHashPair',
      '10': 'ghostdagData'
    },
  ],
};
...
final $typed_data.Uint8List blockWithTrustedDataMessageDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List daaBlockDescriptor = $convert.base64Decode(
    'CghEYWFCbG9jaxItCgVibG9jaxgDIAEoCzIXLnByb3Rvd2lyZS5CbG9ja01lc3NhZ2VSBWJsb2NrEjsKDGdob3N0ZGFnRGF0YRgCIAEoCzIXLnByb3Rvd2lyZS5HaG9zdGRhZ0RhdGFSDGdob3N0ZGFnRGF0YQ==');
...
final $typed_data.Uint8List daaBlockV4Descriptor = $convert.base64Decode(
    'CgpEYWFCbG9ja1Y0Ei4KBmhlYWRlchgBIAEoCzIWLnByb3Rvd2lyZS5CbG9ja0hlYWRlclIGaGVhZGVyEjsKDGdob3N0ZGFnRGF0YRgCIAEoCzIXLnByb3Rvd2lyZS5HaG9zdGRhZ0RhdGFSDGdob3N0ZGFnRGF0YQ==');
...
final $typed_data.Uint8List blockGhostdagDataHashPairDescriptor =
    $convert.base64Decode(
        'ChlCbG9ja0dob3N0ZGFnRGF0YUhhc2hQYWlyEiMKBGhhc2gYASABKAsyDy5wcm90b3dpcmUuSGFzaFIEaGFzaBI7CgxnaG9zdGRhZ0RhdGEYAiABKAsyFy5wcm90b3dpcmUuR2hvc3RkYWdEYXRhUgxnaG9zdGRhZ0RhdGE=');
...
const GhostdagData$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.protowire.BluesAnticoneSizes',
      '10': 'bluesAnticoneSizes'
    },
  ],
};
...
final $typed_data.Uint8List ghostdagDataDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List bluesAnticoneSizesDescriptor = $convert.base64Decode(
    'ChJCbHVlc0FudGljb25lU2l6ZXMSKwoIYmx1ZUhhc2gYASABKAsyDy5wcm90b3dpcmUuSGFzaFIIYmx1ZUhhc2gSIgoMYW50aWNvbmVTaXplGAIgASgNUgxhbnRpY29uZVNpemU=');
...
final $typed_data.Uint8List doneBlocksWithTrustedDataMessageDescriptor =
    $convert.base64Decode('CiBEb25lQmxvY2tzV2l0aFRydXN0ZWREYXRhTWVzc2FnZQ==');
...
final $typed_data.Uint8List pruningPointsMessageDescriptor = $convert.base64Decode(
    'ChRQcnVuaW5nUG9pbnRzTWVzc2FnZRIwCgdoZWFkZXJzGAEgAygLMhYucHJvdG93aXJlLkJsb2NrSGVhZGVyUgdoZWFkZXJz');
...
final $typed_data.Uint8List requestPruningPointProofMessageDescriptor =
    $convert.base64Decode('Ch9SZXF1ZXN0UHJ1bmluZ1BvaW50UHJvb2ZNZXNzYWdl');
...
const PruningPointProofMessage$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.protowire.PruningPointProofHeaderArray',
      '10': 'headers'
    },
  ],
};
...
final $typed_data.Uint8List pruningPointProofMessageDescriptor =
    $convert.base64Decode(
        'ChhQcnVuaW5nUG9pbnRQcm9vZk1lc3NhZ2USQQoHaGVhZGVycxgBIAMoCzInLnByb3Rvd2lyZS5QcnVuaW5nUG9pbnRQcm9vZkhlYWRlckFycmF5UgdoZWFkZXJz');
...
final $typed_data.Uint8List pruningPointProofHeaderArrayDescriptor =
    $convert.base64Decode(
        'ChxQcnVuaW5nUG9pbnRQcm9vZkhlYWRlckFycmF5EjAKB2hlYWRlcnMYASADKAsyFi5wcm90b3dpcmUuQmxvY2tIZWFkZXJSB2hlYWRlcnM=');
...
final $typed_data.Uint8List readyMessageDescriptor =
    $convert.base64Decode('CgxSZWFkeU1lc3NhZ2U=');
...
const BlockWithTrustedDataV4Message$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'ghostdagDataIndices',
      '3': 3,
      '4': 3,
      '5': 4,
      '10': 'ghostdagDataIndices'
    },
  ],
};
...
final $typed_data.Uint8List blockWithTrustedDataV4MessageDescriptor =
    $convert.base64Decode(
        'Ch1CbG9ja1dpdGhUcnVzdGVkRGF0YVY0TWVzc2FnZRItCgVibG9jaxgBIAEoCzIXLnByb3Rvd2lyZS5CbG9ja01lc3NhZ2VSBWJsb2NrEioKEGRhYVdpbmRvd0luZGljZXMYAiADKARSEGRhYVdpbmRvd0luZGljZXMSMAoTZ2hvc3RkYWdEYXRhSW5kaWNlcxgDIAMoBFITZ2hvc3RkYWdEYXRhSW5kaWNlcw==');
...
final $typed_data.Uint8List trustedDataMessageDescriptor = $convert.base64Decode(
    'ChJUcnVzdGVkRGF0YU1lc3NhZ2USMwoJZGFhV2luZG93GAEgAygLMhUucHJvdG93aXJlLkRhYUJsb2NrVjRSCWRhYVdpbmRvdxJICgxnaG9zdGRhZ0RhdGEYAiADKAsyJC5wcm90b3dpcmUuQmxvY2tHaG9zdGRhZ0RhdGFIYXNoUGFpclIMZ2hvc3RkYWdEYXRh');
